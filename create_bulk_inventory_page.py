...
"""
import os
os.makedirs("src/app/admin/products/bulk-inventory", exist_ok=True)
with open("src/app/admin/products/bulk-inventory/page.tsx", "w", encoding="utf-8") as f:
    f.write(new_page)
print("Created bulk inventory page")
