with open("src/lib/coupons.ts", "r", encoding="utf-8") as f:
    content = f.read()

new_content = """import { connectDB } from "@/lib/mongodb";
...
with open("src/lib/coupons.ts", "w", encoding="utf-8") as f:
    f.write(new_content)
print("Updated coupons.ts")
