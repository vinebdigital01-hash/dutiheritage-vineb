...
export function AdminButton({
  ...
  return (
    <button
      type={type}
      className={`inline-flex items-center justify-center gap-2 px-4 py-2.5 text-[12px] tracking-[1.5px] uppercase font-medium transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed rounded-lg ${styles[variant]} ${className}`}
      {...props}
    >
      {children}
    </button>
