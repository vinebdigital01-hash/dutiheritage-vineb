...
import_statement = 'import { AdminButton, AdminInput, AdminSelect, AdminTextarea, useToast, PageHeader } from "./ui";'
new_imports = """import { AdminButton, AdminInput, AdminSelect, AdminTextarea, useToast, PageHeader } from "./ui";
...
with open("src/components/admin/ProductForm.tsx", "w", encoding="utf-8") as f:
    f.write(content)
print("Injected helper components")
